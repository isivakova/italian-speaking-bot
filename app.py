...
=================================================
Flask webhook: receives voice messages, transcribes with faster-whisper,
assesses with Claude, replies with structured feedback via Telegram.
    ...
    if "voice" in message:
        ...
        if text in ("/start", "ciao", "hello", "hi"):
            send_message(chat_id,
                ...
                "Ogni giorno riceverai una domanda — rispondi con un messaggio vocale "
                "e ti darò un feedback dettagliato! 🎙️"
            )
